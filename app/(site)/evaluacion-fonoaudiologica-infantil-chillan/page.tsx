...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.katialafono.cl/servicios/evaluacion-fonoaudiologica",
  },
};
      ...
      <main className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <article className="prose prose-rose lg:prose-lg max-w-none">
          ...
          <div className="mt-12 text-center">
            <WhatsAppCTA href="https://wa.me/56995497838?text=Hola,%20quisiera%20agendar%20una%20evaluaci%C3%B3n%20fonoaudiol%C3%B3gica%20en%20Chill%C3%A1n">
