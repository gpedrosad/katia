...
export const metadata: Metadata = {
  title: "¿Mi Hijo No Habla Bien? Señales de Alerta",
      ...
      <main className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <article className="prose prose-amber lg:prose-lg max-w-none">
          ...
          <div className="mt-12 flex justify-center">
            <WhatsAppCTA href="https://wa.me/56995497838?text=Hola,%20me%20preocupa%20que%20mi%20hijo%20no%20habla%20bien.%20Necesito%20consulta%20en%20Chill%C3%A1n" className="bg-amber-600 hover:bg-amber-700 ring-amber-300">
