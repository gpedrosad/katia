      ...
      <main className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <article className="prose prose-indigo lg:prose-lg max-w-none">
          ...
          <div className="mt-12 flex justify-center">
            <WhatsAppCTA href="https://wa.me/56995497838?text=Hola,%20siento%20que%20mi%20hijo%20habla%20muy%20poco%20para%20su%20edad,%20busco%20hora%20en%20Chill%C3%A1n" className="bg-indigo-600 hover:bg-indigo-700 ring-indigo-300">
