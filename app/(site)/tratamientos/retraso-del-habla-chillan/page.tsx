      ...
      <main className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <article className="prose prose-blue lg:prose-lg max-w-none">
          ...
          <div className="mt-12 flex justify-center">
            <WhatsAppCTA href="https://wa.me/56995497838?text=Hola,%20quiero%20agendar%20por%20retraso%20del%20habla%20en%20Chill%C3%A1n" className="bg-blue-600 hover:bg-blue-700 ring-blue-300">
