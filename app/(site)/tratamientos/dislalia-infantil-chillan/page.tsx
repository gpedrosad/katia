      ...
      <main className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <article className="prose prose-teal lg:prose-lg max-w-none">
          ...
          <div className="mt-12 flex justify-center">
            <WhatsAppCTA href="https://wa.me/56995497838?text=Hola,%20busco%20ayuda%20para%20la%20pronunciaci%C3%B3n/dislalia%20en%20Chill%C3%A1n" className="bg-teal-600 hover:bg-teal-700 ring-teal-300">
