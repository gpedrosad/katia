...
export const metadata: Metadata = {
  title: "Tratamiento Trastorno Fonológico en Chillán",
      ...
      <main className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <article className="prose prose-orange lg:prose-lg max-w-none">
          ...
          <div className="mt-12 flex justify-center">
            <WhatsAppCTA href="https://wa.me/56995497838?text=Hola,%20busco%20ayuda%20por%20trastorno%20fonol%C3%B3gico%20en%20Chill%C3%A1n" className="bg-orange-600 hover:bg-orange-700 ring-orange-300">
