      ...
      <main className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <article className="prose prose-purple lg:prose-lg max-w-none">
          ...
          <div className="mt-12 flex justify-center">
            <WhatsAppCTA href="https://wa.me/56995497838?text=Hola,%20necesito%20evaluaci%C3%B3n/tratamiento%20por%20TEL%20en%20Chill%C3%A1n" className="bg-purple-600 hover:bg-purple-700 ring-purple-300">
